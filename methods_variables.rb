...
p user_name.delete (user_name) # this method calls to delete the variable user_name.  It should return as empty.
...
p last_login.squeeze! ("12/10/2021") # I found that the exclamation point after the method often means it will us an exception on failure rather than returing something silently, or nothing at all.  So in this case the method
